...
public class ValidationFilter implements Filter {
    ...
    private static final boolean debugVar = true;
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            //creating validaterequestwrapper object with current request 
            chain.doFilter(new ValidateRequestWrapper((HttpServletRequest) request), response);
        } catch (Throwable t) {
